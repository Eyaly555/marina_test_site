            ...
            <div className="container">
                ...
                >
                    ...
                    <p className="excellence-subtitle">
                        Ищете результат? Вы по адресу. Основательница центра работает в сфере образования с 2008 года, а сам центр «Ариадна» функционирует как учебный центр с 2017 года. Мы объединяем профессионализм без компромиссов и поддерживающее эмоциональное сопровождение.
                    </p>
                </motion.div>
